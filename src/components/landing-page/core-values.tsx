...
function CoreValues() {
  return (
    <main className=" flex flex-col px-[clamp(1.8rem,4.1vw,3.7rem)] pt-[clamp(5.2rem,10vw,9.4rem)] items-center justify-center gap-[clamp(3rem,7vw,6.3rem)]">
      ...
      <div className=" grid grid-cols-2 gap-[clamp(0.6rem,1.6vw,1.5rem)] gap-y-[clamp(2rem,4vw,4rem)]  max-[515px]:grid-cols-1">
        <section className=" bg-[#F3F4F6] dark:bg-[#FFFFFF33]  px-[clamp(1.8rem,4.1vw,3.7rem)]  pb-[clamp(0.9rem,2.1vw,1.9rem)] rounded-tl-[30px] rounded-tr-lg rounded-br-[30px] rounded-bl-lg flex flex-col gap-[16px] items-center min-w-[230px] ">
          <div className=" dark:bg-primary   bg-white px-[clamp(0.9rem,2.1vw,1.5rem)] py-[clamp(0.8rem,1.8vw,1.6rem)] flex items-center rounded-full -mt-[45px] w-[clamp(3rem,5.5vw,5rem)] h-[clamp(3rem,5.5vw,5rem)] max-[1191px]:-mt-[38px]  max-[872px]:-mt-[25px]">
            <TransparencyIcon />
          </div>
        ...
        <section className=" bg-[#F3F4F6]  px-[clamp(1.8rem,4.1vw,3.7rem)]  pb-[clamp(0.9rem,2.1vw,1.9rem)] rounded-tl-[30px] rounded-tr-lg rounded-br-[30px] rounded-bl-lg flex flex-col gap-[16px] items-center min-w-[230px] ">
